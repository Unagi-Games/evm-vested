...
const { TESTNET_POLYGON_PROVIDER_URL, POLYGON_PROVIDER_URL, TESTNET_GOERLI_PROVIDER_URL, ETHEREUM_PROVIDER_URL, TESTNET_BSC_PROVIDER_URL, BSC_PROVIDER_URL, MNEMONIC_SECRET, POLYGONSCAN_API_KEY, BSCSCAN_API_KEY, ETHERSCAN_API_KEY } = process.env;
...
if(!BSCSCAN_API_KEY) {
  throw new Error('Missing env BSCSCAN_API_KEY');
}
