...
export interface MgcTokenContract extends Truffle.Contract<MgcTokenInstance> {
  "new"(
    predicate: string,
    meta?: Truffle.TransactionDetails
  ): Promise<MgcTokenInstance>;
}
...
export interface MgcTokenInstance extends Truffle.ContractInstance {
  ...
  /**
   * Mint new tokens. Requirements: - Caller must have role PREDICATE_ROLE. - The contract must not be paused.
   */
  mint: {
    (
      user: string,
