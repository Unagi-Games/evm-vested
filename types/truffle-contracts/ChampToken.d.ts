...
export interface ChampTokenContract
  extends Truffle.Contract<ChampTokenInstance> {
  "new"(
    holders: string[],
    balances: (number | BN | string)[],
    meta?: Truffle.TransactionDetails
  ): Promise<ChampTokenInstance>;
}
...
export interface ChampTokenInstance extends Truffle.ContractInstance {
