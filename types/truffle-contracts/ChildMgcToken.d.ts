...
export interface ChildMgcTokenContract
  extends Truffle.Contract<ChildMgcTokenInstance> {
  "new"(
    depositor: string,
    meta?: Truffle.TransactionDetails
  ): Promise<ChildMgcTokenInstance>;
}
...
export interface ChildMgcTokenInstance extends Truffle.ContractInstance {
  ...
  /**
   * Minting can be done as per requirement, This implementation allows only admin to mint tokens but it can be changed as per requirement
   * Example function to handle minting tokens on matic chain
