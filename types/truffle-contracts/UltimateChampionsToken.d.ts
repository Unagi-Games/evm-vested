...
export interface UltimateChampionsTokenContract
  extends Truffle.Contract<UltimateChampionsTokenInstance> {
  "new"(
    holders: string[],
    balances: (number | BN | string)[],
    meta?: Truffle.TransactionDetails
  ): Promise<UltimateChampionsTokenInstance>;
}
...
export interface UltimateChampionsTokenInstance
