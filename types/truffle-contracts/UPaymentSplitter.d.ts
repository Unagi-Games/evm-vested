...
export interface UPaymentSplitterContract
  extends Truffle.Contract<UPaymentSplitterInstance> {
  "new"(
    payees: string[],
    shares_: (number | BN | string)[],
    meta?: Truffle.TransactionDetails
  ): Promise<UPaymentSplitterInstance>;
}
...
export interface UPaymentSplitterInstance extends Truffle.ContractInstance {
  /**
