...
export interface IERC777UpgradeableContract
  extends Truffle.Contract<IERC777UpgradeableInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IERC777UpgradeableInstance>;
}
...
export interface IERC777UpgradeableInstance extends Truffle.ContractInstance {
  /**
