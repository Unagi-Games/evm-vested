...
export interface IERC20PermitUpgradeableContract
  extends Truffle.Contract<IERC20PermitUpgradeableInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<IERC20PermitUpgradeableInstance>;
}

type AllEvents = never;

export interface IERC20PermitUpgradeableInstance
