...
export interface LockedChampTokenContract
  extends Truffle.Contract<LockedChampTokenInstance> {
  "new"(
    champAddress: string,
    meta?: Truffle.TransactionDetails
  ): Promise<LockedChampTokenInstance>;
}
...
export interface LockedChampTokenInstance extends Truffle.ContractInstance {
  /**
